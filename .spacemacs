...
you should place your code here."
  ...
  ;; Popup for spellcheck
  ;;(setq-default flycheck-scalastylerc "/usr/local/etc/scalastyle_config.xml")

  (setq flycheck-dafny-executable "/usr/local/lib/dafny/dafny")
  (setq flycheck-boogie-executable "/usr/local/lib/dafny/BOOGIE")
  (setq flycheck-z3-smt2-executable "/usr/local/lib/z3/bin/z3")
